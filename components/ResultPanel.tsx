    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
          ...
          <IconButton
            title={downloading ? 'Downloading…' : 'Download .docx'}
            onClick={handleDownload}
          >
            <IconDownload
              size={15}
              style={downloading ? { animation: 'spin 1s linear infinite' } : undefined}
            />
          </IconButton>
          <IconButton
            title={uploading ? 'Uploading…' : 'Save to Google Drive'}
            onClick={handleDriveUpload}
          >
            <IconCloud
              size={15}
              style={uploading ? { animation: 'spin 1s linear infinite' } : undefined}
            />
          </IconButton>
        </div>
      </div>
